...
with the old server's host discovery / UI startsetups (/selectdest, /lsithost, /connect, /osinfo)
and background QUIC server starter.

Drop this file into your project, ensure the startsetup modules (quic_transfer, scanner, startsetup)
...
# QUIC client/server startsetups (from your project)
